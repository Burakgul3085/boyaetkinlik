...
<div
    id="site-sticky-ad"
    class="pointer-events-auto fixed inset-x-0 bottom-0 z-30 h-[56px] border-t border-violet-100/70 bg-white/88 pb-[env(safe-area-inset-bottom,0px)] pt-1 shadow-[0_-6px_16px_rgba(76,29,149,0.09)] backdrop-blur-lg dark:border-slate-700 dark:bg-slate-950/85 dark:shadow-[0_-8px_18px_rgba(0,0,0,0.42)]"
    role="complementary"
    aria-label="Sponsor alanı"
>
    <div class="mx-auto flex h-full max-w-4xl items-center gap-1.5 px-2 pb-1 sm:px-3">
        <div class="flex h-[38px] flex-1 items-center rounded-lg border border-violet-100/80 bg-white/95 px-2 shadow-sm dark:border-slate-700 dark:bg-slate-900/90">
