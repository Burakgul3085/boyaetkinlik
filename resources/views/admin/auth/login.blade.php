...
<div class="relative z-10 w-full max-w-md">
    <div>
        <form method="post" action="{{ route('admin.login.submit') }}" class="w-full rounded-3xl border border-white/20 bg-slate-900/55 p-7 text-slate-100 shadow-2xl shadow-black/45 backdrop-blur-md">
            ...
            <a href="{{ route('admin.register') }}" class="mt-3 block w-full rounded-xl border border-violet-300/45 bg-violet-500/20 px-4 py-3 text-center text-sm font-semibold text-violet-100 transition hover:bg-violet-500/30">Admin Üye Ol</a>
